...
namespace VentaElectrodomesticos.Controladores {
    class ValidatorHelper
    {
        ...
        public ValidatorHelper add(TextBox c, Label l, params Func<TextBox, bool>[] criteriaList)
        {
        ...
        public ValidatorHelper add(ComboBox c, Label l, params Func<ComboBox, bool>[] criteriaList)
        {
        ...
        // Validadores Especiales
        public ValidatorHelper add(CheckedListBox c, Label l, params Func<CheckedListBox, bool>[] criteriaList)
        {
        ...
        public ValidatorHelper add(Cliente c, Label l, params Func<Cliente, bool>[] criteriaList)
        {
        ...
        public ValidatorHelper add(Empleado c, Label l, params Func<Empleado, bool>[] criteriaList)
        {
        ...
        public ValidatorHelper add(Producto c, Label l, params Func<Producto, bool>[] criteriaList)
        {
        ...
        public ValidatorHelper add(Usuario c, Label l, params Func<Usuario, bool>[] criteriaList)
        {
        ...
        public ValidatorHelper add(Categoria c, Label l, params Func<Categoria, bool>[] criteriaList)
        {
        ...
        public ValidatorHelper add(TextBox c1, TextBox c2, Label l1, Label l2, params Func<TextBox, TextBox,  bool>[] criteriaList)
        {
